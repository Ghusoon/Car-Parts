...
const Form = props => (
  ...
  <option value="Chevy Blazer, Full Size">Chevy Blazer, Full Size</option>
  ...
  <option value="Chevy S/10/S15/Sonoma">Chevy S/10/S15/Sonoma</option>
  ...
  <option value="Dodge Promaster 1500">Dodge Promaster 1500</option>
  <option value="Dodge Promaster 2500">Dodge Promaster 2500</option>
  <option value="Dodge Promaster 3500">Dodge Promaster 3500</option>
  ...
  <option value="Dodge Van (Promaster City)">Dodge Van (Promaster City)</option>
  ...
  <option value="IH (All except Scout)">IH (All except Scout)</option>
  ...
  <option value="Lexus 250ES">Lexus 250ES</option>
  ...
  <option value="Lexus RX400 Hybrid">Lexus RX400 Hybrid</option>
  ...
  <option value="Toyota Corolla not FX">Toyota Corolla not FX</option>
  ...
  <option value="Dash Bezel">Dash Bezel</option>
  <option value="Dash Pad">Dash Pad</option>
  <option value="Dash Panel">Dash Panel</option>
  <option value="Dash Wiring Harness/Misc Electric">Dash Wiring Harness/Misc Electric</option>
  ...
  <option value="Electrical Part Misc and Wiring">Electrical Part Misc and Wiring</option>
  ...
  <option value="Fender Inner Liner">Fender Inner Liner</option>
  ...
  <option value="Headlamp Ballast">Headlamp Ballast</option>
  <option value="Headlamp Bulb">Headlamp Bulb</option>
  ...
  <option value="Headlight Switch (Dash)">Headlight Switch (Dash)</option>
  ...
  <option value="Seat, Back (3rd)">Seat, Back (3rd)</option>
  <option value="Seat, Front">Seat, Front</option>
  <option value="Seat, Rear (2nd)">Seat, Rear (2nd)</option>
  ...
  <option value="Trailer Hitch/Tow Hook/Winch">Trailer Hitch/Tow Hook/Winch</option>
  ...
  <option value="Wiring Harness/Misc. Electric">Wiring Harness/Misc. Electric</option>
  <option value="Yoke/U-Joint">Yoke/U-Joint</option>
  </select>

  </div>
    <div className="pull-left">
      <button onClick={props.handleFormSubmit} type="submit" className="btn btn-lg btn-secondary">Submit</button>
  </div>
  </form>

  <a href="http://www.facebook.com/"><img src="graphics/sm_f.gif" alt="Facebook" width="20" height="20" border="0" /></a>
	<a href="http://www.linkedin.com/"><img src="graphics/sm_l.gif" alt="LinkedIn" width="20" height="20" border="0" /></a>
	<a href="http://www.twitter.com/"><img src="graphics/sm_t.gif" alt="Twitter" width="20" height="20" border="0" /></a>
